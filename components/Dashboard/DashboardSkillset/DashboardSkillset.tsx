...
export const DashboardSkillset = ({ skillset }: DashboardSkillsetProps) => {
  ...
  return (
    <div className="flex flex-col flex-start sm:w-full max-sm:w-full md:w-[calc(50%-6px)] lg:w-[calc(33%-6px)] gap-2 border-2 p-8 shadow-lg border-zinc-500 dark:border-zinc-700">
